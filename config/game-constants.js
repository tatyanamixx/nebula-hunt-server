...
const GAME_CONSTANTS = {
	...
	ECONOMY: {
		...
		STARDUST_TO_STARS_RATIO: 100, // Base ratio - will be adjusted based on star count (increased for better balance with upgrades)
		...
		INITIAL_STARDUST: 10000,
		INITIAL_DARK_MATTER: 50,
		INITIAL_STARS: 1000,
