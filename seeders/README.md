...
7. **20250701000008-package-templates.js** - Шаблоны пакетов
8. **20250701000009-demo-user-upgrades.js** - Демонстрационные улучшения пользователей
9. **20250701000010-demo-user-tasks.js** - Демонстрационные задания пользователей
10. **20250701000011-demo-user-events.js** - Демонстрационные события пользователей
11. **20250701000012-demo-market-offers.js** - Демонстрационные предложения рынка
