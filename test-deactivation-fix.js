...
async function testDeactivationFix() {
	...
	try {
		console.log('🧪 Тестирование исправленной логики деактивации...\n');
		...
		const registrationResult = await UserService.login(
			...
			'1234567890',
			{
				seed: `deactivation_fix_galaxy_${Date.now()}`,
				starMin: 100,
				starCurrent: 150,
				price: 100,
				particleCount: 100,
				...
				galaxyProperties: {
					name: 'Deactivation Fix Test Galaxy',
					type: 'spiral',
					color: '#4A90E2',
					size: 'medium',
					complexity: 0.7,
					description: 'A galaxy for deactivation fix testing',
				},
			}
		);
